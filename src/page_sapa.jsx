// Sa Pa Hub — market screening only. NO Sondax-specific sections (per workspace rule).
...
function SapaHubPage({ go }) {
  const H = DATA.sapaHub;
  ...
  return (
    <div className="page-anim">
      ...
      <section className="section" style={{ paddingBlock: '72px 48px' }}>
        <div className="stage">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 24 }}>
            <span className="folio" style={{ color: 'var(--accent)' }}>DESTINATION HUB · SA PA</span>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 0, marginTop: 40, borderTop: '2px solid var(--ink)' }}>
            {[
              { label: 'GMV 2025', val: H.market.gmv2025, sub: 'tour market Sa Pa' },
      ...
      <section className="section">
        <div className="stage">
          <SectionHeader kicker="Tổng quan thị trường" title="Ai đến Sa Pa — và book qua đâu." dek="Tổng hợp toàn tỉnh. Chi tiết từng sản phẩm bên dưới." />
      ...
      {flagship && (
        <section className="section" style={{ background: 'var(--paper-3)' }}>
          <div className="stage">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 24 }}>
              <span className="folio" style={{ color: 'var(--accent)' }}>SẢN PHẨM DẪN ĐẦU SA PA</span>
            ...
            <div className="grid-2" style={{ gridTemplateColumns: '1.3fr 1fr', gap: 64, borderTop: '2px solid var(--ink)', paddingTop: 32 }}>
              <div>
                ...
                <p className="body" style={{ fontSize: 16, color: 'var(--ink-2)', marginBottom: 20, lineHeight: 1.55 }}>
                  SKU chiếm 22% thị phần foreign. Sapa Sisters (4,080+2,895 reviews · 4.7★) + Ethos Spirit (800+ · 4.8★) + Topas Ecolodge (Conde Nast Top-3 Asia 2025). KR package +333% H1 2025 — market reshape lớn nhất từ Fansipan cable car 2016.
                </p>
                <button
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 0, borderLeft: '1px solid var(--rule)' }}>
                {[
                  { label: 'Traffic', val: flagship.traffic, sub: flagship.trafficNote || '#1 Sa Pa' },
                        ...
                        {t.emergingNote
                          ...
                          : t.isFlagship
                            ...
                            : t.skeleton
                              ...
                              : t._growthNum >= 25
                                ? 'Đà tăng mạnh · KR surge hoặc premium tier. Cửa sổ 12–18 tháng consolidate.'
                                : t._growthNum >= 10
        ...
        <section className="section" style={{ background: 'var(--paper-2)' }}>
          <div className="stage">
            <SectionHeader
              ...
              title="Ai đang chạy loop market Sa Pa."
            />
            <div style={{ borderTop: '2px solid var(--ink)' }}>
      ...
      <div className="stage">
        <div className="footer">
          <div className="row">
            <div>SAPA-HUB · DESTINATION HUB · PHÂN TÍCH THỊ TRƯỜNG</div>
...
// ═════════════════════════════════════════════════════════════════════════════
// SapaVariantDetail — per-variant detail. NO SondaxPlaybookSection per rule.
// ═════════════════════════════════════════════════════════════════════════════

function SapaVariantDetail({ id, go }) {
  const H = DATA.sapaHub;
  ...
  if (!v) return (
    <div className="page-anim">
      <section className="section"><div className="stage">
        ...
        <button onClick={() => go({ tab: 'tours', id: 'sapa-hub' })} style={{ marginTop: 20, fontFamily: 'var(--mono)', fontSize: 11, padding: '10px 18px', background: 'var(--ink)', color: 'var(--paper)', border: 'none', cursor: 'pointer' }}>← Về Sa Pa Hub</button>
      </div></section>
    </div>
  );
  ...
  return (
    <div className="page-anim">
      ...
      <section className="section" style={{ paddingBlock: '48px 48px' }}>
        <div className="stage">
          <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
            {v.isFlagship && <span style={{ background: 'var(--accent)', color: 'var(--paper)', fontSize: 10, padding: '3px 8px', fontFamily: 'var(--mono)', letterSpacing: '0.1em' }}>#1 FLAGSHIP SA PA</span>}
          ...
          <div className="stage">
            <div style={{ padding: '20px 24px', borderLeft: '3px solid var(--ink-3)', background: 'var(--paper-3)' }}>
              ...
              <div style={{ fontFamily: 'var(--sans)', fontSize: 15, lineHeight: 1.6, color: 'var(--ink-2)' }}>
                Skeleton SKU — thin volume + fragmented ops. Monitor only. Nội Bài–Lào Cai expressway 4-lane 2026 có thể unlock demand.
              </div>
            </div>
          </div>
        </section>
      ...
      <div className="stage">
        <div className="footer">
          <div className="row">
            <div>SAPA-HUB · {v.id.toUpperCase()} · PHÂN TÍCH SẢN PHẨM</div>
...
export default SapaHubPage;
export { SapaVariantDetail };
