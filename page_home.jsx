...
function TourPreview() {
  const tours = window.DATA.tours.slice(0, 4);
  return (
...
function MarketPreview() {
  const mk = window.DATA.markets.filter((m) => m.hasDetail || ['in', 'ph', 'uk'].includes(m.id)).slice(0, 5);
  return (
