...
import { SubVariantsSection, SondaxPlaybookSection } from './page_hanoi.jsx';
      ...
      <section className="section" style={{ paddingBlock: '72px 48px' }}>
        <div className="stage">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 0, marginTop: 40, borderTop: '2px solid var(--ink)' }}>
            {[
              { label: 'GMV 2025', val: H.market.gmv2025, sub: 'tour market Halong' },
        ...
        <section className="section" style={{ background: 'var(--paper-2)' }}>
          <div className="stage">
            <SectionHeader
              ...
              dek="Mined từ TripAdvisor + Viator reviews 2024–2025. Mỗi pain → một cơ hội differentiation."
            />
            <div style={{ borderTop: '2px solid var(--ink)' }}>
        ...
        <section className="section">
          <div className="stage">
            <SectionHeader
              ...
              dek="Quote thật lấy từ TripAdvisor + Viator + Direct reviews 2024–2025."
            />
