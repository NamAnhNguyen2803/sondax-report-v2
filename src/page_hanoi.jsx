...
function HanoiProductDetail({ id, go }) {
  ...
  return (
    <div className="page-anim">
      ...
      {/* 3. Xu hướng sản phẩm qua các năm (historical + forecast) */}
      {!v.skeleton && v.history && (() => {
      ...
      {/* 4. Pain points specific to this tour (non-skeleton) */}
      ...
      {/* 5. Voice of customer (non-skeleton) */}
